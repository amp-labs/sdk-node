...
import { CreateProviderAppServerList } from "../models/operations/createproviderapp.js";
import * as operations from "../models/operations/index.js";
import { Result } from "../types/fp.js";

export enum CreateProviderAppAcceptEnum {
 ...
 */
export async function providerAppCreateProviderApp(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.CreateProviderAppProviderAppResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreateProviderAppServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      422,
      errors.CreateProviderAppProviderAppResponseBody$inboundSchema,
      { ctype: "application/problem+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
