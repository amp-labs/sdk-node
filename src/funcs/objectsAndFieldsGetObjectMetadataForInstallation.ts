...
export enum GetObjectMetadataForInstallationAcceptEnum {
 ...
 */
export async function objectsAndFieldsGetObjectMetadataForInstallation(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetObjectMetadataForInstallationServerList[0], {
