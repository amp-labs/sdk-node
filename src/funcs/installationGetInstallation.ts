...
import { GetInstallationServerList } from "../models/operations/getinstallation.js";
import * as operations from "../models/operations/index.js";
import { Result } from "../types/fp.js";

export enum GetInstallationAcceptEnum {
 ...
 * Get an installation
 */
export async function installationGetInstallation(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetInstallationServerList[0], { charEncoding: "percent" })();
