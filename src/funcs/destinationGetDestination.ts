...
import { GetDestinationServerList } from "../models/operations/getdestination.js";
import * as operations from "../models/operations/index.js";
import { Result } from "../types/fp.js";

export enum GetDestinationAcceptEnum {
 ...
 * Get a destination
 */
export async function destinationGetDestination(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetDestinationServerList[0], { charEncoding: "percent" })();
