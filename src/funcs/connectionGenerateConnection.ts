...
import { GenerateConnectionServerList } from "../models/operations/generateconnection.js";
import * as operations from "../models/operations/index.js";
import { Result } from "../types/fp.js";

export enum GenerateConnectionAcceptEnum {
 ...
 */
export async function connectionGenerateConnection(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.GenerateConnectionConnectionResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GenerateConnectionServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      422,
      errors.GenerateConnectionConnectionResponseBody$inboundSchema,
      { ctype: "application/problem+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
