...
import { DeleteDestinationServerList } from "../models/operations/deletedestination.js";
 ...
 */
export async function destinationDeleteDestination(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteDestinationServerList[0], {
