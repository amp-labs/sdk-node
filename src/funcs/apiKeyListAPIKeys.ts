...
import { ListApiKeysServerList } from "../models/operations/listapikeys.js";
 ...
 * List API keys
 */
export async function apiKeyListAPIKeys(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.ListApiKeysResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListApiKeysServerList[0], { charEncoding: "percent" })();
  ...
  >(
    ...
    M.jsonErr(404, errors.ListApiKeysResponseBody$inboundSchema, {
      ctype: "application/problem+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListApiKeysResponse$inboundSchema, {
      ctype: "application/problem+json",
    }),
