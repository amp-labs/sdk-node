...
import { CreateProjectServerList } from "../models/operations/createproject.js";
...
export async function projectCreateProject(
  ...
  Result<
    ...
    | errors.CreateProjectResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreateProjectServerList[0], { charEncoding: "percent" })();
  ...
  >(
    ...
    M.jsonErr(422, errors.CreateProjectResponseBody$inboundSchema, {
