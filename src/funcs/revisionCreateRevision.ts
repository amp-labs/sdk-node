...
import { CreateRevisionServerList } from "../models/operations/createrevision.js";
 ...
 */
export async function revisionCreateRevision(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.CreateRevisionRevisionResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreateRevisionServerList[0], { charEncoding: "percent" })();
  ...
  >(
    ...
    M.jsonErr(422, errors.CreateRevisionRevisionResponseBody$inboundSchema, {
      ctype: "application/problem+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
