...
export enum OauthConnectAcceptEnum {
 ...
 */
export async function oAuthOauthConnect(
  client: SDKCore,
  request: operations.OauthConnectRequestBody,
  options?: RequestOptions & { acceptHeaderOverride?: OauthConnectAcceptEnum },
): Promise<
  Result<
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(OauthConnectServerList[0], { charEncoding: "percent" })();
