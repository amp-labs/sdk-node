...
export enum CreateInstallationAcceptEnum {
 ...
 */
export async function installationCreateInstallation(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.CreateInstallationInstallationResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreateInstallationServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      422,
      errors.CreateInstallationInstallationResponseBody$inboundSchema,
      { ctype: "application/problem+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
