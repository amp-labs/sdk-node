...
import { ListConnectionsServerList } from "../models/operations/listconnections.js";
import { Result } from "../types/fp.js";

export enum ListConnectionsAcceptEnum {
 ...
 * List connections
 */
export async function connectionListConnections(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListConnectionsServerList[0], { charEncoding: "percent" })();
