...
import { DeleteInstallationServerList } from "../models/operations/deleteinstallation.js";
 ...
 */
export async function installationDeleteInstallation(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteInstallationServerList[0], {
