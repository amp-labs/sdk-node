...
import { ListOperationsServerList } from "../models/operations/listoperations.js";
import { Result } from "../types/fp.js";

export enum ListOperationsAcceptEnum {
 ...
 * List operations
 */
export async function operationListOperations(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.ListOperationsOperationResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListOperationsServerList[0], { charEncoding: "percent" })();
  ...
  >(
    ...
    M.jsonErr(422, errors.ListOperationsOperationResponseBody$inboundSchema, {
      ctype: "application/problem+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
