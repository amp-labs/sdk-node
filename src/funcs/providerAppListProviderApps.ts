...
import { ListProviderAppsServerList } from "../models/operations/listproviderapps.js";
import { Result } from "../types/fp.js";

export enum ListProviderAppsAcceptEnum {
 ...
 * List provider apps
 */
export async function providerAppListProviderApps(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListProviderAppsServerList[0], { charEncoding: "percent" })();
