...
export enum GetOperationAcceptEnum {
 ...
 * Get an operation
 */
export async function operationGetOperation(
  client: SDKCore,
  request: operations.GetOperationRequest,
  options?: RequestOptions & { acceptHeaderOverride?: GetOperationAcceptEnum },
): Promise<
  Result<
    operations.GetOperationResponse,
    | errors.GetOperationResponseBody
    | errors.GetOperationOperationResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(422, errors.GetOperationOperationResponseBody$inboundSchema, {
      ctype: "application/problem+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
