...
import { ListIntegrationsServerList } from "../models/operations/listintegrations.js";
import { Result } from "../types/fp.js";

export enum ListIntegrationsAcceptEnum {
 ...
 * List integrations
 */
export async function integrationListIntegrations(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListIntegrationsServerList[0], { charEncoding: "percent" })();
