...
import { DeleteIntegrationServerList } from "../models/operations/deleteintegration.js";
 ...
 */
export async function integrationDeleteIntegration(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.DeleteIntegrationIntegrationResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteIntegrationServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      422,
      errors.DeleteIntegrationIntegrationResponseBody$inboundSchema,
      { ctype: "application/problem+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
