...
import { UpdateProviderAppServerList } from "../models/operations/updateproviderapp.js";
import { Result } from "../types/fp.js";

export enum UpdateProviderAppAcceptEnum {
 ...
 */
export async function providerAppUpdateProviderApp(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateProviderAppServerList[0], {
