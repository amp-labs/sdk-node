...
import { UpdateDestinationServerList } from "../models/operations/updatedestination.js";
import { Result } from "../types/fp.js";

export enum UpdateDestinationAcceptEnum {
 ...
 */
export async function destinationUpdateDestination(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.UpdateDestinationDestinationResponseBody
    | errors.UpdateDestinationDestinationResponseResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateDestinationServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors.UpdateDestinationDestinationResponseBody$inboundSchema,
      { ctype: "application/problem+json" },
    ),
    M.jsonErr(
      422,
      errors.UpdateDestinationDestinationResponseResponseBody$inboundSchema,
      { ctype: "application/problem+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
