...
import { CreateDestinationServerList } from "../models/operations/createdestination.js";
import * as operations from "../models/operations/index.js";
import { Result } from "../types/fp.js";

export enum CreateDestinationAcceptEnum {
 ...
 */
export async function destinationCreateDestination(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.CreateDestinationDestinationResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreateDestinationServerList[0], {
  ...
  >(
    ...
    M.jsonErr(
      422,
      errors.CreateDestinationDestinationResponseBody$inboundSchema,
      { ctype: "application/problem+json" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
