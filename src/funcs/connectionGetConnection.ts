...
import { GetConnectionServerList } from "../models/operations/getconnection.js";
import * as operations from "../models/operations/index.js";
import { Result } from "../types/fp.js";

export enum GetConnectionAcceptEnum {
 ...
 * Get a connection
 */
export async function connectionGetConnection(
  client: SDKCore,
  request: operations.GetConnectionRequest,
  options?: RequestOptions & { acceptHeaderOverride?: GetConnectionAcceptEnum },
): Promise<
  Result<
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetConnectionServerList[0], { charEncoding: "percent" })();
