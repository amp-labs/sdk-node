...
* [getObjectMetadataForInstallation](#getobjectmetadataforinstallation) - Get object metadata for installation
* [getObjectMetadataForConnection](#getobjectmetadataforconnection) - Get object metadata for connection

## getObjectMetadataForInstallation
...
async function run() {
  const result = await sdk.objectsAndFields.getObjectMetadataForInstallation({
...
import { objectsAndFieldsGetObjectMetadataForInstallation } from "openapi/funcs/objectsAndFieldsGetObjectMetadataForInstallation.js";
...
async function run() {
  const res = await objectsAndFieldsGetObjectMetadataForInstallation(sdk, {
    projectIdOrName: "<value>",
    integrationId: "<id>",
    objectName: "<value>",
  });
...
async function run() {
  const result = await sdk.objectsAndFields.getObjectMetadataForConnection({
    projectIdOrName: "<value>",
    provider: "<value>",
    objectName: "<value>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { objectsAndFieldsGetObjectMetadataForConnection } from "openapi/funcs/objectsAndFieldsGetObjectMetadataForConnection.js";
...
async function run() {
  const res = await objectsAndFieldsGetObjectMetadataForConnection(sdk, {
    projectIdOrName: "<value>",
    provider: "<value>",
    objectName: "<value>",
  });
