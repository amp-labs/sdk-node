...
* [getMetadataForInstallation](#getmetadataforinstallation) - Get object metadata for installation
* [getMetadataForConnection](#getmetadataforconnection) - Get object metadata for connection
