...
* [getApiKey](#getapikey) - Get an API key
...
async function run() {
  const result = await sdk.apiKey.listApiKeys({
...
import { apiKeyListAPIKeys } from "openapi/funcs/apiKeyListAPIKeys.js";
...
async function run() {
  const res = await apiKeyListAPIKeys(sdk, {
    projectIdOrName: "<value>",
  });
...
| ------------------------------ | ------------------------------ | ------------------------------ |
| errors.ListApiKeysResponseBody | 404                            | application/problem+json       |
...
async function run() {
  const result = await sdk.apiKey.createApiKey({
    projectIdOrName: "<value>",
    requestBody: {
...
```typescript
import { SDKCore } from "openapi/core.js";
import { apiKeyCreateAPIKey } from "openapi/funcs/apiKeyCreateAPIKey.js";
...
async function run() {
  const res = await apiKeyCreateAPIKey(sdk, {
    projectIdOrName: "<value>",
    requestBody: {
      label: "MailMonkey API Key",
      scopes: [
...
| Error Type                      | Status Code                     | Content Type                    |
| ------------------------------- | ------------------------------- | ------------------------------- |
| errors.CreateApiKeyResponseBody | 404                             | application/problem+json        |
| errors.APIError                 | 4XX, 5XX                        | \*/\*                           |
...
async function run() {
  const result = await sdk.apiKey.getApiKey({
    projectIdOrName: "<value>",
    apiKey: "<value>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { apiKeyGetAPIKey } from "openapi/funcs/apiKeyGetAPIKey.js";
...
async function run() {
  const res = await apiKeyGetAPIKey(sdk, {
    projectIdOrName: "<value>",
    apiKey: "<value>",
  });
...
| Error Type                   | Status Code                  | Content Type                 |
| ---------------------------- | ---------------------------- | ---------------------------- |
| errors.GetApiKeyResponseBody | 404                          | application/problem+json     |
| errors.APIError              | 4XX, 5XX                     | \*/\*                        |
...
```typescript
import { SDKCore } from "openapi/core.js";
import { apiKeyDeleteAPIKey } from "openapi/funcs/apiKeyDeleteAPIKey.js";
...
async function run() {
  const res = await apiKeyDeleteAPIKey(sdk, {
    projectIdOrName: "<value>",
    apiKey: "<value>",
  });
...
| Error Type                      | Status Code                     | Content Type                    |
| ------------------------------- | ------------------------------- | ------------------------------- |
| errors.DeleteApiKeyResponseBody | 404                             | application/problem+json        |
| errors.APIError                 | 4XX, 5XX                        | \*/\*                           |
...
async function run() {
  const result = await sdk.apiKey.updateApiKey({
    projectIdOrName: "<value>",
    apiKey: "<value>",
    requestBody: {
      updateMask: [
...
```typescript
import { SDKCore } from "openapi/core.js";
import { apiKeyUpdateAPIKey } from "openapi/funcs/apiKeyUpdateAPIKey.js";
...
async function run() {
  const res = await apiKeyUpdateAPIKey(sdk, {
    projectIdOrName: "<value>",
    apiKey: "<value>",
    requestBody: {
      updateMask: [
...
| Error Type                                    | Status Code                                   | Content Type                                  |
| --------------------------------------------- | --------------------------------------------- | --------------------------------------------- |
| errors.UpdateApiKeyResponseBody               | 400                                           | application/problem+json                      |
| errors.UpdateAPIKeyAPIKeyResponseBody         | 404                                           | application/problem+json                      |
| errors.UpdateAPIKeyAPIKeyResponseResponseBody | 422                                           | application/problem+json                      |
| errors.APIError                               | 4XX, 5XX                                      | \*/\*                                         |