...
* [createRevision](#createrevision) - Create a new revision
* [getHydratedRevision](#gethydratedrevision) - Hydrate a revision
...
async function run() {
  const result = await sdk.revision.createRevision({
...
import { revisionCreateRevision } from "openapi/funcs/revisionCreateRevision.js";
...
async function run() {
  const res = await revisionCreateRevision(sdk, {
    projectIdOrName: "<value>",
    integrationId: "<id>",
  });
...
| errors.CreateRevisionRevisionResponseBody | 422                                       | application/problem+json                  |
...
async function run() {
  const result = await sdk.revision.getHydratedRevision({
    projectIdOrName: "<value>",
    integrationId: "<id>",
    revisionId: "<id>",
    connectionId: "<id>",
...
```typescript
import { SDKCore } from "openapi/core.js";
import { revisionGetHydratedRevision } from "openapi/funcs/revisionGetHydratedRevision.js";
...
async function run() {
  const res = await revisionGetHydratedRevision(sdk, {
    projectIdOrName: "<value>",
    integrationId: "<id>",
    revisionId: "<id>",
    connectionId: "<id>",
...
| errors.GetHydratedRevisionRevisionResponseBody | 422                                            | application/problem+json                       |
| errors.APIError                                | 4XX, 5XX                                       | \*/\*                                          |