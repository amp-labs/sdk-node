# CreateInstallationInstallationGroup

## Example Usage

```typescript
import { CreateInstallationInstallationGroup } from "openapi/models/operations";

let value: CreateInstallationInstallationGroup = {
  groupRef: "group-123",
