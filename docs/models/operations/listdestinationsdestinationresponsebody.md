# ListDestinationsDestinationResponseBody

## Example Usage

```typescript
import { ListDestinationsDestinationResponseBody } from "openapi/models/operations";

let value: ListDestinationsDestinationResponseBody = {
  id: "<id>",
