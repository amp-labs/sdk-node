# ListProviderAppsProviderAppResponseBody

## Example Usage

```typescript
import { ListProviderAppsProviderAppResponseBody } from "openapi/models/operations";

let value: ListProviderAppsProviderAppResponseBody = {
  id: "provider-app-123",
